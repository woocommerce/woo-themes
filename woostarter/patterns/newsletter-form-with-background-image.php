...
<!-- wp:jetpack/button {"element":"button","text":"Subscribe","textColor":"theme-2","backgroundColor":"theme-1","width":"100%","lock":{"move":true,"remove":true},"className":"is-style-fill"} /-->
</div>
