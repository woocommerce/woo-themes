...
<figure class="wp-block-image size-full is-resized"><img src="?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon-verse.png" alt="A black leaf icon symbolizing nature or sustainability." class="wp-image-589" style="width:24px"/></figure>
<!-- /wp:image -->
