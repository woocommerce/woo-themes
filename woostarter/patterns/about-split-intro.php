...
<!-- wp:group {"metadata":{"name":"Split layout with image, text on the right","categories":["about"],"patternName":"woostarter/split-layout-intro"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/about-page-image.webp","id":331,"alt":"Antique bottles in a dimly lit arched alcove with a textured wall.","dimRatio":0,"customOverlayColor":"#775d4a","isUserOverlayColor":false,"style":{"dimensions":{"aspectRatio":"1"}},"layout":{"type":"default"}} -->
<div class="wp-block-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#775d4a"></span><img class="wp-block-cover__image-background wp-image-331" alt="Antique bottles in a dimly lit arched alcove with a textured wall." src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/about-page-image.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
