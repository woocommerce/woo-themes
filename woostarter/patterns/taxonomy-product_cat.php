 ...
 * Slug: woostarter/taxonomy-product_cat
 * Inserter: no
 */
?>
...
<!-- wp:group {"tagName":"main","metadata":{"name":"Archive"},"style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}},"layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:woocommerce/product-results-count {"fontSize":"medium","style":{"layout":{"selfStretch":"fill","flexSize":null}}} /-->

<!-- wp:woocommerce/catalog-sorting {"fontSize":"medium"} /--></div>
<!-- /wp:group -->
