 ...
 * Slug: woostarter/hidden-woocommerce-product-search-results
 * Inserter: no
 */
?>
...
<div class="wp-block-woocommerce-product-collection alignwide"><!-- wp:query-title {"type":"search","level":2,"showPrefix":false,"align":"wide","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}}},"fontSize":"x-large"} /-->

<!-- wp:search {"showLabel":false,"placeholder":"<?php esc_html_e('Search products...', 'woostarter');?>","buttonText":"Search","query":{"post_type":"product"},"style":{"border":{"color":"rgba(17, 17, 17, 0.2)","radius":"0px"}},"fontSize":"medium"} /-->

<!-- wp:woocommerce/product-collection-no-results {"align":"wide"} -->
 
<!-- wp:pattern {"slug":"woostarter/hidden-no-search-results"} /-->
