...
<div class="wp-block-jetpack-contact-form is-style-animated" style="padding-top:0;padding-bottom:0">
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size">Subscribe to our newsletter</h3>
<!-- /wp:heading -->
<!-- wp:jetpack/field-email {"label":"","placeholder":"Your email"} /-->
<!-- wp:jetpack/button {"element":"button","text":"Subscribe","lock":{"move":false,"remove":false}} /-->
</div>
...
<!-- wp:social-links {"iconColor":"contrast","iconColorValue":"#111111","size":"has-small-icon-size","className":"is-style-logos-only","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|30"}}}} -->
...
<!-- wp:column {"width":"20%"} -->
<div class="wp-block-column" style="flex-basis:20%"><!-- wp:spacer {"height":"var:preset|spacing|30"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"is-style-default","fontSize":"medium"} -->
<p class="is-style-default has-medium-font-size">Shop</p>
<!-- /wp:paragraph -->
...
<p class="has-medium-font-size">Info</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">United Kingdom (GBP £)</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"0"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
<div class="wp-block-group alignwide" style="padding-top:0"><!-- wp:paragraph {"style":{"typography":{"fontSize":"12px"}}} -->
<p style="font-size:12px">© 2025 Kiri. Designed with WordPress</p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"typography":{"fontSize":"12px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="font-size:12px"><!-- wp:paragraph -->
