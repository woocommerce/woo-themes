...
<!-- wp:group {"tagName":"main","metadata":{"name":"Archive"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:query-title {"type":"archive","level":2,"fontSize":"xx-large"} /-->
