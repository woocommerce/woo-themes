...
<!-- wp:group {"metadata":{"name":"Header Container"},"align":"full","className":"is-style-default","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull is-style-default" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:spacer {"height":"var:preset|spacing|30","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
...
<div class="wp-block-group"><!-- wp:navigation {"ref":10,"metadata":{"ignoredHookedBlocks":["woocommerce/customer-account"]},"className":"order-1 md:order-0"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"60%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%"><!-- wp:site-title {"textAlign":"center","style":{"typography":{"textTransform":"capitalize"}},"fontFamily":"platypi"} /--></div>
<!-- /wp:column -->
...
<!-- wp:woocommerce/mini-cart {"miniCartIcon":"bag-alt","style":{"spacing":{"margin":{"left":"0.5em"}}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
