...
<p class="has-text-align-center has-theme-4-color has-text-color"><?php echo esc_html_x( 'The page you\'re looking for could not be found. Maybe try a search?', '404 error message', 'purple' ); ?></p>
<!-- /wp:paragraph -->
