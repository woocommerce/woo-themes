...
<h2 class="wp-block-heading"><?php esc_html_e( 'Europe', 'woostarter' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Asia &amp; Australia', 'woostarter' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'North America', 'woostarter' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'South America', 'woostarter' ); ?></h2>
<!-- /wp:heading -->
