...
<div class="wp-block-group alignfull"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Pattern-placeholder.webp","dimRatio":50,"customOverlayColor":"#3d3d3e","isUserOverlayColor":false,"minHeight":60,"minHeightUnit":"vh","sizeSlug":"large","align":"full","layout":{"type":"constrained"}} -->
