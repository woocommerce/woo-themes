...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon-truck.webp" alt="" style="width:32px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
