 ...
 * Slug: woostarter/footer-three-columns
 * Categories: footer
 * Block Types: core/template-part/footer
 */
?>
<!-- wp:group {"metadata":{"name":"Footer with three columns"},"align":"full","className":"is-style-default","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull is-style-default" style="padding-top:0;padding-bottom:0"><!-- wp:spacer {"height":"var:preset|spacing|50"} -->
<div style="height:var(--wp--preset--spacing--50)" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"><!-- wp:paragraph {"fontSize":"x-large"} -->
<p class="has-x-large-font-size"><?php esc_html_e('Elke is a Berlin-based brand making bold knitwear designed with care, using responsibly sourced, natural fibers that are as kind to the environment as they are to your skin.', 'woostarter');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-columns alignwide"><!-- wp:column {"width":"33%","layout":{"type":"default"}} -->
<div class="wp-block-column" style="flex-basis:33%"><!-- wp:heading {"textAlign":"left","level":3,"fontSize":"medium"} -->
...
<div class="wp-block-column" style="flex-basis:33%"><!-- wp:heading {"textAlign":"left","level":3,"fontSize":"medium"} -->
<h3 class="wp-block-heading has-text-align-left has-medium-font-size"><?php esc_html_e('Follow us', 'woostarter');?></h3>
<!-- /wp:heading -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
<!-- wp:navigation-link {"label":"<?php esc_html_e('Instagram', 'woostarter');?>","url":"#"} /-->

<!-- wp:navigation-link {"label":"<?php esc_html_e('Newsletter', 'woostarter');?>","url":"#"} /-->

<!-- wp:navigation-link {"label":"<?php esc_html_e('TikTok', 'woostarter');?>","url":"#"} /-->

<!-- wp:navigation-link {"label":"<?php esc_html_e('Pinterest', 'woostarter');?>","url":"#"} /-->
<!-- /wp:navigation --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:column {"width":"33%"} -->
<div class="wp-block-column" style="flex-basis:33%"><!-- wp:heading {"textAlign":"left","level":3,"fontSize":"medium"} -->
<h3 class="wp-block-heading has-text-align-left has-medium-font-size"><?php esc_html_e('Country/Language', 'woostarter');?></h3>
<!-- /wp:heading -->
