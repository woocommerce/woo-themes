...
<h2 class="wp-block-heading alignwide has-text-align-left has-theme-2-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0"><?php esc_html_e('More from the journal', 'woostarter');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|theme-4"}}}},"textColor":"theme-4"} -->
<p class="has-theme-4-color has-text-color has-link-color"><?php esc_html_e('The latest news on sustainability, knitwear and clothing care guides.', 'woostarter');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
