 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Four columns of store features with icons","categories":["text","about"],"patternName":"woostarter/store-features-four-columns-alternative"},"align":"full","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-column" style="padding-top:0;padding-bottom:0"><!-- wp:columns {"metadata":{"categories":["text","about"],"patternName":"woostarter/store-features-four-columns-alternative"},"align":"wide","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"blockGap":{"top":"var:preset|spacing|60","left":"0"}}}} -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon-pin.webp" alt="<?php esc_attr_e('Pin icon', 'woostarter');?>" style="width:32px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"32px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon-payment.webp" alt="<?php esc_attr_e('Payment icon', 'woostarter');?>" style="width:32px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
