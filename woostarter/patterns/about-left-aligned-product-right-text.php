...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/product-view1.webp","alt":"<?php esc_attr_e( 'An illustration of of folded shirts', 'woostarter' ); ?>","dimRatio":40,"isDark":false,"style":{"dimensions":{"aspectRatio":"4/3"}},"layout":{"type":"default"}} -->
...
<p class="has-text-align-center has-xx-large-font-size" style="line-height:1.2"><?php esc_html_e('New Collection', 'woostarter');?></p>
<!-- /wp:paragraph -->
