...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/beanie-a.webp","alt":"<?php esc_attr_e( 'An illustration of a wool beanie', 'woostarter' ); ?>","dimRatio":40,"isDark":false,"style":{"dimensions":{"aspectRatio":"4/3"}},"layout":{"type":"default"}} -->
