...
<!-- wp:group {"tagName":"main","metadata":{"name":"Search Results"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0"><!-- wp:spacer {"height":"var:preset|spacing|60"} -->
<div style="height:var(--wp--preset--spacing--60)" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"><!-- wp:query-title {"type":"search","textAlign":"left","level":2,"fontSize":"xx-large"} /-->

<!-- wp:search {"showLabel":false,"placeholder":"Search blog posts...","buttonText":"Search","style":{"border":{"radius":"100px"}},"backgroundColor":"primary","textColor":"background","fontSize":"medium","borderColor":"theme-4"} /--></div>
<!-- /wp:group -->
