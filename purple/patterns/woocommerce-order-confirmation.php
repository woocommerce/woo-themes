...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('Order details', 'purple');?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('Downloads', 'purple');?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('Shipping address', 'purple');?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('Billing address', 'purple');?></h2>
<!-- /wp:heading -->
