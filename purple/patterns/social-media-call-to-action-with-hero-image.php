...
<!-- wp:group {"metadata":{"name":"Social media call to action with hero image","patternName":"purple/social-media-call-to-action-with-hero-image","description":"A social media call to action with a hero image.","categories":["purple"]},"align":"full","className":"is-style-section-1","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull is-style-section-1" style="margin-top:0;margin-bottom:0"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/blue-sweater-cut.webp","alt":"<?php esc_attr_e( 'Model wearing a blue knit sweater', 'purple' ); ?>","dimRatio":40,"overlayColor":"theme-2","isUserOverlayColor":true,"focalPoint":{"x":0.5,"y":0.28},"minHeight":60,"minHeightUnit":"vh","sizeSlug":"full","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
