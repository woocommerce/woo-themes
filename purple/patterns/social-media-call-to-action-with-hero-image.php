...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/storytelling-store-2.webp","alt":"<?php esc_attr_e( 'Minimalist clothing store exterior with a colourful sweatshirt display.', 'purple' ); ?>","dimRatio":30,"isUserOverlayColor":true,"minHeight":60,"minHeightUnit":"vh","sizeSlug":"full","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50);min-height:60vh"><img class="wp-block-cover__image-background size-full" alt="<?php esc_attr_e( 'Minimalist clothing store exterior with a colourful sweatshirt display.', 'purple' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/storytelling-store-2.webp" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"style":{"typography":{"textAlign":"center"}}} -->
...
<p class="has-text-align-center" style="font-style:normal"><?php
	printf(
		...
		esc_html__( '%1$s@woocommerce%2$s', 'purple' ),
		'<a href="#">',
		'</a>'
	);
	?></p>
