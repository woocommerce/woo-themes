...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/product-socks-yellow-purple-theme-1.webp" alt="<?php esc_attr_e('Mustard-yellow chunky cable-knit crew socks.', 'purple');?>" style="aspect-ratio:1;object-fit:cover;width:220px;height:auto"/></figure>
<!-- /wp:image -->
