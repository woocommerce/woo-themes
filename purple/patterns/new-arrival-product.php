...
<div class="wp-block-group alignfull has-theme-5-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90)"><!-- wp:image {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/product-socks-yellow-purple-theme-1.webp","width":"220px","aspectRatio":"3/4","scale":"cover","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/product-socks-yellow-purple-theme-1.webp" alt="<?php esc_attr_e('Mustard-yellow chunky cable-knit crew socks.', 'purple');?>" style="aspect-ratio:3/4;object-fit:cover;width:220px;height:auto"/></figure>
<!-- /wp:image -->
