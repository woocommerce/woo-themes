...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/pink-sweater-woman.webp" alt="<?php esc_attr_e( 'Female model in a pink knit sweater and matching trousers on a pale pink background.', 'purple' ); ?>" style="aspect-ratio:3/4;object-fit:cover;object-position:77% 49%;width:227px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/blue-sweater-man-standing.webp" alt="<?php esc_attr_e( 'Male model in a blue knit sweater leaning against a wall.', 'purple' ); ?>" style="aspect-ratio:1;object-fit:cover;object-position:4% 57%;width:553px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/yellow-knit-closeup.webp" alt="<?php esc_attr_e( 'Close-up of mustard yellow knit fabric.', 'purple' ); ?>" style="aspect-ratio:4/3;object-fit:cover;width:592px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
