...
<!-- wp:column {"width":"50%"} -->
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/blue-sweater-man.webp","alt":"<?php esc_attr_e( 'Model in a cobalt blue knit sweater on a blue-grey backdrop.', 'purple' ); ?>","dimRatio":10,"isUserOverlayColor":true,"focalPoint":{"x":0.16,"y":0.42},"minHeight":100,"minHeightUnit":"vh","contentPosition":"bottom right","isDark":false,"sizeSlug":"full","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"padding":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20","top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}},"color":[]},"layout":{"type":"default"}} -->
<div class="wp-block-cover is-light has-custom-content-position is-position-bottom-right" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:100vh"><img class="wp-block-cover__image-background size-full" alt="<?php esc_attr_e( 'Model in a cobalt blue knit sweater on a blue-grey backdrop.', 'purple' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/blue-sweater-man.webp" style="object-position:16% 42%" data-object-fit="cover" data-object-position="16% 42%"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-10 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"className":"underline-link","style":{"elements":{"link":{"color":{"text":"var:preset|color|theme-1"}}},"typography":{"lineHeight":"1.71"}},"fontSize":"small"} -->
