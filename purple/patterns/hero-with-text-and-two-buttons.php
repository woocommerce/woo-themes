...
<p class="has-text-align-left has-xx-large-font-size"><?php esc_html_e('Colorful knits, crafted to last', 'purple');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size"><?php esc_html_e('Bold knits designed with care—for you and the planet.', 'purple');?></p>
<!-- /wp:paragraph -->
