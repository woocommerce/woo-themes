...
<div class="wp-block-group alignwide"><!-- wp:paragraph {"align":"left","placeholder":"Write title…"} -->
<p class="has-text-align-left"><?php esc_html_e('Colorful knits, crafted to last', 'purple');?></p>
<!-- /wp:paragraph -->
