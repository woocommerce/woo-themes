 ...
 * Description: A best sellers section with a heading and 4 column product carousel.
...
<div class="wp-block-woocommerce-product-collection alignwide"><!-- wp:group {"className":"wc-product-collection-carousel-header","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
<div class="wp-block-group wc-product-collection-carousel-header"><!-- wp:heading {"style":{"typography":{"textAlign":"center","lineHeight":"1.21"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"x-large"} --><h2 class="wp-block-heading has-text-align-center has-x-large-font-size" style="margin-top:0;margin-bottom:0;line-height:1.21"><?php esc_html_e( 'Best sellers', 'purple' );?></h2>
<!-- /wp:heading -->
