...
<p class="has-text-align-center" style="margin-top:var(--wp--preset--spacing--10)"><?php esc_html_e( 'All our garments are made of authentic 100% sheep’s wool.', 'purple' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"textAlign":"center"},"spacing":{"margin":{"top":"var:preset|spacing|10"}}}} -->
<p class="has-text-align-center" style="margin-top:var(--wp--preset--spacing--10)"><?php esc_html_e( 'Suitable to any winter wardrobe.', 'purple' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|10","bottom":"0"}},"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center" style="margin-top:var(--wp--preset--spacing--10);margin-bottom:0"><?php esc_html_e( 'Keep your feet warm.', 'purple' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|10","bottom":"0"}},"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center" style="margin-top:var(--wp--preset--spacing--10);margin-bottom:0"><?php esc_html_e( 'A touch of personality.', 'purple' ); ?></p>
<!-- /wp:paragraph -->
