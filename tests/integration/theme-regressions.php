...
purple_test_assert( wp_get_theme( 'ci-placeholder' )->exists(), 'The placeholder theme must be installed.' );

switch ( $stage ) {
	case 'prepare-customized-cart':
		purple_test_assert( 'ci-placeholder' === get_stylesheet(), 'The placeholder theme must be active during setup.' );
